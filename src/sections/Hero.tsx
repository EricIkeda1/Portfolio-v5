...
const getSocialLinks = (whatsappNumber: string, email: string, github: string, linkedin: string) => [
  {
  ...
  {
    label: linkedin.replace(/^https?:\/\/(www\.)?/, ''),
    href: linkedin,
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V8.997h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.289zM5.337 7.433a2.062 2.062 0 1 1 0-4.124 2.062 2.062 0 0 1 0 4.124zM7.119 20.452H3.555V8.997h3.564v11.455z" />
      </svg>
    ),
  },
  {
...
export default function Hero() {
  ...
  const socialLinks = getSocialLinks(whatsappNumber, content.email, content.github, content.linkedin)
      ...
      <div className="container">
        <div className="hero-grid">
          ...
          <div
            ...
            style={{
              animation:
                'heroScale 0.75s cubic-bezier(0.22,1,0.36,1) 200ms both',
              position: 'relative',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            <div
              style={{
                ...
                borderRadius: '50%',
                background:
                  'radial-gradient(circle, rgba(66,133,255,0.14) 0%, transparent 70%)',
                filter: 'blur(24px)',
              }}
            />
        ...
        >
          ...
          {[0, 1, 2].map((i) => (
            <svg
              ...
              fill="none"
              style={{
                animation: `chevronCascade 1.4s ease-in-out ${
                  i * 220
                }ms infinite`,
                display: 'block',
                marginTop: i === 0 ? 0 : -3,
      ...
      <a
        ...
        onMouseEnter={(e) => {
          ;(e.currentTarget as HTMLElement).style.boxShadow =
            '0 6px 30px rgba(37,211,102,0.65)'
        }}
        onMouseLeave={(e) => {
          ;(e.currentTarget as HTMLElement).style.boxShadow =

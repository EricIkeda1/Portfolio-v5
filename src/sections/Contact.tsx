...
function getContactItems(email: string, github: string, linkedin: string): ContactItem[] {
  return [
    {
      label: 'Email',
      value: email,
...
export default function Contact() {
  ...
  const contactItems = getContactItems(content.email, content.github, content.linkedin)
